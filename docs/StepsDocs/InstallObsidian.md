# InstallObsidian - Install Obsidian Workflow GitHub App

## Overview

**Component:** `src/pages/Steps/DynamicSteps/InstallObsidian.tsx`  
**Step Number:** 14  
**Category:** install  
**Purpose:** Install the Obsidian Workflow App on GitHub Enterprise to enable @obsidian and @claude triggers in repositories.

## What This Step Does

This step provides users with guidance and instructions for install obsidian workflow github app. The component includes:
...
- https://github.corp.ebay.com/github-apps/obsidian-workflow-app
- https://obsidian.vip.qa.ebay.com/
- https://github.corp.ebay.com/github-apps/obsidian-workflow-app
- https://github.corp.ebay.com/obsidian/claude-code-integration/blob/main/docs/obsidian-user-guide.md
...
**Note:** This documentation was auto-generated. For detailed implementation specifics, review the component source code at `src/pages/Steps/DynamicSteps/InstallObsidian.tsx`.
