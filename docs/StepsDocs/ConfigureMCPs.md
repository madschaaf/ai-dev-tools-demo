# ConfigureMCPs - Configure MCPs

## Overview

**Component:** `src/pages/Steps/DynamicSteps/ConfigureMCPs.tsx`  
**Step Number:** 8  
**Category:** config  
**Purpose:** Set up Model Context Protocol (MCP) servers to give Cline and Claude Code access to eBay tools and services.

## What This Step Does

This step provides users with guidance and instructions for configure mcps. The component includes:
...
- https://pages.github.corp.ebay.com/DevGenAI/ebay-mcp/
- https://pages.github.corp.ebay.com/DevGenAI/ebay-mcp/
...
**Note:** This documentation was auto-generated. For detailed implementation specifics, review the component source code at `src/pages/Steps/DynamicSteps/ConfigureMCPs.tsx`.
