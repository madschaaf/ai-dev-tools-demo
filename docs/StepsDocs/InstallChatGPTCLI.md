# InstallChatGPTCLI - Install Claude Code CLI

## Overview

**Component:** `src/pages/Steps/DynamicSteps/InstallChatGPTCLI.tsx`  
**Step Number:** 6  
**Category:** install  
**Purpose:** Install Claude Code CLI to get AI-powered coding assistance directly in your terminal. This works immediately with your eBay SSO credentials on Day 0.

## What This Step Does

This step provides users with guidance and instructions for install claude code cli. The component includes:
...
- `userOS`: Tracks user o s
- `copiedCommand`: Tracks copied command
...
- https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fdocs%2Fclaude-code%2Foverview
- https://claude.ai
- https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fdocs%2Fclaude-code%2Foverview
...
**Note:** This documentation was auto-generated. For detailed implementation specifics, review the component source code at `src/pages/Steps/DynamicSteps/InstallChatGPTCLI.tsx`.
