# RoleSelection - Select Your Engineer Role

## Overview

**Component:** `src/pages/Steps/DynamicSteps/RoleSelection.tsx`  
**Step Number:** N/A  
**Category:** setup  
**Purpose:** Choose your primary engineering role to get a personalized setup experience. We'll tailor the setup steps to include tools and configurations specific to your role.

## What This Step Does

This step provides users with guidance and instructions for select your engineer role. The component includes:
...
**Note:** This documentation was auto-generated. For detailed implementation specifics, review the component source code at `src/pages/Steps/DynamicSteps/RoleSelection.tsx`.
