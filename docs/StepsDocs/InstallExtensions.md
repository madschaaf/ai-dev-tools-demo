...
**Component:** `src/pages/Steps/DynamicSteps/InstallExtensions.tsx`  
**Step Number:** 12  
**Category:** install  
**Purpose:** Clone the AI Dev Tools repository to automatically get all recommended VS Code extensions.

## What This Step Does

This step provides users with guidance and instructions for install vs code extensions. The component includes:
...
- https://github.com/madschaaf/ai-dev-tools
...
**Note:** This documentation was auto-generated. For detailed implementation specifics, review the component source code at `src/pages/Steps/DynamicSteps/InstallExtensions.tsx`.
