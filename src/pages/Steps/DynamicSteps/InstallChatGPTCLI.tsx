...
export default function InstallChatGPTCLI() {
  ...
  return (
    <>
      ...
      <h4 style={{ marginTop: 'var(--space-3)' }}>1. Open Terminal</h4>
      ...
      <h4 style={{ marginTop: 'var(--space-3)' }}>2. Run Installation Command</h4>
      ...
      <div style={{ background: '#f6f8fa', padding: 'var(--space-3)', borderRadius: 'var(--radius-md)', marginTop: 'var(--space-2)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 'var(--space-3)' }}>
          <code style={{ flex: 1, whiteSpace: 'pre-wrap', wordBreak: 'break-all', fontSize: '0.85rem' }}>{claudeInstallCommand}</code>
          <button
            type="button"
        ...
        <p style={{ margin: 'var(--space-2) 0 0', fontSize: '0.85rem', color: 'var(--color-neutral-700)' }}>
          This installs Claude Code CLI from eBay's internal repository
        </p>
      </div>

      <h4 style={{ marginTop: 'var(--space-3)' }}>3. Launch Claude Code CLI</h4>
      <p style={{ fontSize: '0.9rem', color: 'var(--color-neutral-700)', marginBottom: 'var(--space-2)' }}>
        After installation completes, start Claude Code CLI:
      </p>
      ...
      <div style={{ background: '#f6f8fa', padding: 'var(--space-3)', borderRadius: 'var(--radius-md)', marginTop: 'var(--space-2)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 'var(--space-3)' }}>
          ...
          <button
            type="button"
            onClick={() => handleCopy('claude', 'claude-run')}
            style={{
              padding: '6px 12px',
              fontSize: '0.85rem',
              borderRadius: 'var(--radius-sm)',
      ...
      <h4 style={{ marginTop: 'var(--space-3)' }}>4. Authenticate with eBay SSO</h4>
      <ol style={{ marginTop: 'var(--space-2)' }}>
        <li><strong>Sign in:</strong> When prompted, authenticate with your eBay email and corporate credentials</li>
        <li style={{ marginTop: 'var(--space-2)' }}><strong>Network proxy:</strong> If prompted for proxy auth, use your corp username with PIN + YubiKey/OTP</li>
        <li style={{ marginTop: 'var(--space-2)' }}><strong>Start coding:</strong> Once authenticated, you can ask questions and get AI assistance</li>
      </ol>

      <h3 style={{ marginTop: 'var(--space-4)' }}>Troubleshooting</h3>

      <h4 style={{ marginTop: 'var(--space-3)' }}>Authentication Fails</h4>
      <p>Ensure you've installed Netskope Certificates:</p>
      <ul style={{ marginTop: 'var(--space-2)' }}>
        <li><strong>Mac:</strong> Self Service app → "Apply Netskope Certificates"</li>
        <li><strong>Windows:</strong> Software Center → Install Netskope certificates</li>
        <li>Restart terminal after installing certificates</li>
      </ul>

      <h4 style={{ marginTop: 'var(--space-3)' }}>Command Not Found</h4>
      <p>If you see "command not found: claude":</p>
      <ol style={{ marginTop: 'var(--space-2)' }}>
        <li>Close and reopen your terminal to reload PATH</li>
        <li>If still not working, add to PATH manually:
      ...
      <div className="callout" style={{ background: '#e8f5e9', borderColor: '#a5d6a7', color: '#2e7d32', marginTop: 'var(--space-3)' }}>
        <strong>Web Browser Alternative:</strong>
        <p style={{ margin: '8px 0 0', fontSize: '0.9rem' }}>
          ...
          . Sign in with your eBay credentials to access the same AI assistant.
        </p>
      </div>
    </>
  )
