...
import UseCaseStepDemo from './pages/UseCaseStepDemo'
import StaticSubmission from './pages/StaticSubmission'
      ...
      <div className="container">
       <section className="quick-links-section hero">
        ...
        <Routes>
          ...
          <Route path="/use-case-step-demo" element={<UseCaseStepDemo />} />
          <Route path="/static-submission" element={<StaticSubmission />} />
