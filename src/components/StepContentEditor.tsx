...
export function StepContentEditor({ content, onChange, onCancel, onSave, hideButtons = false, hideAddButton = false }: StepContentEditorProps) {
  ...
  // Sync internal state when content prop changes (e.g., from sticky add button)
  React.useEffect(() => {
    setItems(content);
  }, [content]);
