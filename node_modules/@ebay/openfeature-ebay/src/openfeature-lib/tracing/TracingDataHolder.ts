...
class TracingDataHolderClass {
    private traceIdToCalData: Map<string, FeatureFlagRawEvent[]> = new Map();
     ...
     */
    public addEntry(traceId: string, featureFlagRawEvents: FeatureFlagRawEvent[]): void {
     ...
     */
    public getCalDataListById(traceId: string): FeatureFlagRawEvent[] {
     ...
     */
    public getCalDataList(): Map<string, FeatureFlagRawEvent[]> {
        const result = new Map<string, FeatureFlagRawEvent[]>();
     ...
     */
    public removeByTraceId(traceId: string): void {
     ...
     */
    public removeTraceIdMap(): void {
        this.traceIdToCalData.clear();
    }
}

export const TracingDataHolder = new TracingDataHolderClass();
