...
var httpTransport = require('@ebay/service-instruments-ebay/transports/http-transport');
var caller = require('caller');

var Utils = require('./utils');

var logger = require('@ebay/logging-inc').logger('service-client-ebay/index');
    ...
    context: function context(ctx) {
        ...
        return {
            getClient: function getClient(id) {
                ...
                var pipe = pipes[id] = pipes[id] || pipeTemplate.build();
