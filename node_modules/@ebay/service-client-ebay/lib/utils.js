...
/**
 * Converts all object keys to lower case.
 * Source: https://stackoverflow.com/questions/12539574/whats-the-best-way-most-efficient-to-turn-all-the-keys-of-an-object-to-lower
 * @param  {Object} origObj Original object to be lower cased.
 * @return {Object}         New object with keys lower cased.
 */
module.exports.objectKeysToLowerCase = function objectKeysToLowerCase(origObj) {
...
module.exports.setupContext = function setupContext(options, callback) {
    ...
    var oauth = require('@ebay/oauth-ebay');
