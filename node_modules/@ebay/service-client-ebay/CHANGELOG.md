...
## 4.4.1
* Typescript change to allow extending to more specific response data type

## 4.4.0
* Typescript support for service-client-ebay module, https://jirap.corp.ebay.com/browse/NODE-3643

## 4.3.4
* Fix: leak of web request into a new context request-local is not available, https://jirap.corp.ebay.com/browse/NODE-3585

## 4.3.3
Fix: res.setHeader NPE when service-client-ebay is used outside of request flow, https://jirap.corp.ebay.com/browse/NODE-3429

## 4.3.2
* Added support for legacy transition mode

## 4.3.1
* Corrected transition mode which resulted in failure to call services at FE side

## 4.3.0
* Added support for Browser -> FE -> BE bridge, https://jirap.corp.ebay.com/browse/NODE-3201

## v4.2.1
* Removed instrument-ebay module

## v4.2.0 - __Contributed by Scott Davis__
* Accept oauth token from service-use tag 

## v4.0.8
* User's Oracle ID leaked on ebay.com, https://jirap.corp.ebay.com/browse/NODE-1947

## v4.0.7
* Issue 88: Ignore case when filtering by allowedHeaders in service-use
...
## v0.1.7
* Enhancement: Enabled to use `@ebay/streams-ebay` module to support SSE, JSON Streams
