  ...
  ***************************************************-->
  <xsl:template match="Component[@name = 'Host Information']">
    ...
    <xsl:apply-templates select="Properties/Property[@name = 'OS']"/>
        <xsl:apply-templates select="Properties/Property[@name = 'OS Name']"/>
  ...
  <xsl:if test="Properties/Property[@name = 'ServletContainer']">
    ...
    <xsl:apply-templates select="Properties/Property[@name = 'RBI Version']"/>
    <xsl:apply-templates select="Properties/Property[@name = 'Base Image Version']"/>
...
<!--******************************************************
  ...
  ***************************************************-->
  ...
  <tr class="{$color}">
    <xsl:apply-templates select="Property[contains(@name, 'Name')]" mode="viewconfig"/>
    ...
    <xsl:apply-templates select="Property[@name = 'Effective Endpoint']" mode="single_td"/>
    <xsl:apply-templates select="Property[@name = 'Original Endpoint']" mode="single_td"/>
    <xsl:apply-templates select="Property[@name = 'Service Id']" mode="single_td"/>
    ...
    <xsl:apply-templates select="Property[contains(@name, 'TLS Version')]" mode="single_td"/>
  </tr>
  </xsl:template>
<!--******************************************************
