...
var getRequest = exports.getRequest = function getRequest(out, dontCheckResponse) {
    ...
    var request = platform ? platform.request : global.req;
...
var getResponse = exports.getResponse = function getResponse(out, dontCheckRequest) {
    var global = out.global;
    var platform = global.platform;
    var response = platform ? platform.response : global.res;
...
exports.getEbay = function getEbay(out) {
    var global = out.global;
    var platform = global.platform;
    var ebay = platform ? platform.ebay : global.ebay;
