# Next
## v4.3.3
* Vulnerable dependencies used - nconf. Upgrade to the recommended safe version, https://jirap.corp.ebay.com/browse/NODE-3626

## v4.3.2
* Added missing typescript definitions, addData.

## v4.3.0
* Typescript support for cal module, https://jirap.corp.ebay.com/browse/NODE-3674

## v4.2.3
* Added: Support for CAL Pool Name for Container PDLC, https://jirap.corp.ebay.com/browse/NODE-3409

## v4.2.0
* Fixed: should use odbMoName as suffix for staging, https://jirap.corp.ebay.com/browse/NODE-2964

## v4.1.5
* Added: provide option to configure CAL tx release timeout per route, https://jirap.corp.ebay.com/browse/NODE-2780 

## v4.1.4
* Corrected on change event to allow configuration change via config bean, which was broken

## v4.1.3
* Fixed retry logic with backoff reconnect with 500ms interval

## v4.1.2
* NODE-2736: Added Traffic Mirror CAL header
https://jirap.corp.ebay.com/browse/NODE-2736

## v4.1.1
* Fix: poolname without r1 is used to log events.

## v4.1.0
* Added support for sending POD/container info to CAL ingress to support running on k8s
https://docs.google.com/document/d/1IA8EiOlkM_88m-KG1Vb8jwYFDee1ClyGS9DTgFzb6kA/edit
https://jirap.corp.ebay.com/browse/NODE-2415
* Converted config load to async mode

## v4.0.7/v4.0.8
* Fixed node 10 stream issue resulting in a permanant loss of the connection to the cal endpoint and memory leak due to this.

## v4.0.6
* Added support for environment variable based  values for `CAL_HOST` & `CAL_PORT`
https://jirap.corp.ebay.com/browse/NODE-2131

## v4.0.5
* Fixed https://jirap.corp.ebay.com/browse/NODE-2115, now useFileBeatsForCAL env value is compared to `yes` instead of `true`.

## v4.0.4
* Fixed: should not make Error.prototype.toJSON readonly, https://jirap.corp.ebay.com/browse/NODE-2102

## v4.0.3
* Auto Switching of CAL endpoint to `localhost` when `USE_FILEBEATS_FOR_CAL` (useFileBeatsForCAL) env is set to true
