...
[![Build Status](https://go/-/nodejsci/job/nodejs/job/node-cal/job/master/badge/icon)](https://go/-/nodejsci/job/nodejs/job/node-cal/job/master/)
[![security](https://nodevalid-i3ey5.vip.lvs01.dev.ebayc3.com/nodejs/node-cal.svg)](https://nodevalid-i3ey5.vip.lvs01.dev.ebayc3.com/nodejs/node-cal/)  [![Code Coverage](https://nodevalid-i3ey5.vip.lvs01.dev.ebayc3.com/coverage/nodejs/node-cal)](http://sonar/dashboard/index?id=node-cal) 
-----------------------------
...
#### configure releaseTimeout per route

By default cal transaction starts a timer to autoflush all pending CAL data in 25 seconds in case the client does not close/flush transaction due to error or other reason, which is more than enough for a standard transaction. In case your app has longer transaction time for some commands, you can configure releaseTimeout per route using releaseTimeout attribute value in milliseconds

routes.json
```json
[
    {
        "route": "GET /sch/:keywords => ./src/pages/search-results",
        "pageName": "KeywordSearch",
        "security": "L0SESSION"
    },
    {
        "route": "GET /search/:keywords => ./src/pages/search-results-flow",
        "pageName": "KeywordSearch",
        "security": "L0SESSION"
    },
    "GET /sch => ./src/pages/search-results",
    {
        "route": "GET / => ./src/pages/index",
        "pageName":"DefaultPage",
        "releaseTimeout": 40000 
    }
]
```
...
#### Properties
`type` - The message type as specified in the CAL protocol.
