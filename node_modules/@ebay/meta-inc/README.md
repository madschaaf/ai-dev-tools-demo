#meta-inc 
[![Build Status](https://ebayci.qa.ebay.com/CI-Instance/buildStatus/icon?job=meta-inc)](https://ebayci.qa.ebay.com/CI-Instance/job/meta-inc) [![Dependency Status](https://nodevalid-i3ey5.vip.lvs01.dev.ebayc3.com/nodejs/meta-inc.svg)](https://nodevalid-i3ey5.vip.lvs01.dev.ebayc3.com/nodejs/meta-inc)  [![Code Coverage](https://nodevalid-i3ey5.vip.lvs01.dev.ebayc3.com/coverage/nodejs/meta-inc)](http://sonar/dashboard/index?id=meta-inc)
...
See   [CHANGELOG.MD](https://github.corp.ebay.com/nodejs/meta-inc/blob/master/CHANGELOG.md#changelog)
...
```javascript
var meta = require('@ebay/meta-inc');
app.use(meta());
```
...
```javascript
    var metaModel = require('@ebay/meta-inc/lib/metaModel');
    var model = {};
