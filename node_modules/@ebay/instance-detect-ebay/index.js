 ...
 *    small integer in the range 0-(n-1) where n is the number of cores.
 *    If the application is not clustered, the value will always be 0.
...
module.exports.getInstanceId = function getInstanceId() {
  ...
  var instanceId = parseInt(process.env.pm_id, 10);
  return instanceId;
};
