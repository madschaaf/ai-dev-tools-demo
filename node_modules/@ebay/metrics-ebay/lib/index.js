...
var ValidateInternals;

var Monitor = require('./monitor');
var logger = require('@ebay/logging-inc').logger('metrics-ebay/index');
...
var debug = require('debug')('@ebay/metrics-ebay/index');
...
module.exports._createManager = function _createManager(name, options) {
    ...
    ValidateInternals = ValidateInternals || require('@ebay/validate-internals-ebay');
