...
exports.normalizeContentType = function normalizeContentType(headers) {
    headers = headers || {};

    var mainValue = headers['content-type']; // we are going to use lower-case as our main value
    Object.keys(headers).forEach(function (header) {
        var value = headers[header];
        if (/^content-type$/i.test(header)) {
            delete headers[header];
            headers['content-type'] = mainValue || value;
        }
    });
