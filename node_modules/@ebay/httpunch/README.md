...
`body` A string or buffer or readable stream payload for POST and PUT requests.
...
httpunch.request(request, callback);
```
...
```javascript
var agents = require('@ebay/httpunch').agents;
