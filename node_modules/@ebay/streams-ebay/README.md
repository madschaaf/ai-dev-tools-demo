...
var streams = require('@ebay/streams-ebay');
...
```Javascript
var adaptor = require('@ebay/streams-ebay/Adaptor').Adaptor;
var streamsAdaptor = new adaptor();
var provider = require('@ebay/service-client-ebay').getClient('streams');
